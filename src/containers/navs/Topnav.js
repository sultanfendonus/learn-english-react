...
const mapStateToProps = ({ MenuReducers, SettingReducers }) => {
  const { containerClassnames, menuClickCount, selectedMenuHasSubItems } = MenuReducers;
  const { locale } = SettingReducers;
  return {
    containerClassnames,
    menuClickCount,
