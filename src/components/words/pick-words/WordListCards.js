    ...
    render() {
        return (
            <div>
                ...
                <WordListComponents color={'#ad236f'} isHighlightFirstWord={true} wordList={this.props.todaysHistory} emptyMessage="Please pick some words to enable this feature."/>
            </div>
        );
    }
}
