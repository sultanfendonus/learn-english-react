...
export const SET_SINGLE_WORD_EMPTY = "SET_SINGLE_WORD_EMPTY";
export const REORDER_TODAY_HISTORY = "REORDER_TODAY_HISTORY";
export const SET_WORD_MODAL_VISIBILITY = "SET_WORD_MODAL_VISIBILITY";
export const DETAILS_WORD = "DETAILS_WORD";
export const PUSH_TODAY_HISTORY = "PUSH_TODAY_HISTORY";
export const SET_SHOULD_LEARN_HISTORY = "SET_SHOULD_LEARN_HISTORY";
export const SET_REVIEW_WORDS = "SET_REVIEW_WORDS";
export const REMOVE_REVIEW_WORD = "REMOVE_REVIEW_WORD";
export const SET_WORD_SEARCH_RESULT = "SET_WORD_SEARCH_RESULT";
export const SET_WORD_AS_PICKED = "SET_WORD_AS_PICKED";
